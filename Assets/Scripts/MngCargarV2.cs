...
public class MngCargarV2 : MonoBehaviour {
    ...
    {//antes de cargar la escena
		...
		jugador0.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador1.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador2.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador3.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador4.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador5.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador6.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador7.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador8.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2"); 
		jugador9.GetComponent<JugadorV2> ().porteriaRival = GameObject.Find ("porteria2");
